...
export const nav = [
  ...
  { label: 'Honey', href: 'product.html', menu: [
    ...
    ['index.html#kits', 'Black Seed Honey', 'Wave 2', 'assets/img/products/black-seed-honey/front.jpg'],
    ['index.html#kits', 'The Tasting Flight', 'Three 40 g minis', 'assets/img/products/tasting-flight/front.jpg'],
  ]},
  { label: 'Collagen', href: 'marine-collagen.html', menu: [
    ...
    ['index.html#kits', 'Daily Sachets', '30 pre-weighed doses', 'assets/img/products/daily-sachets/front.jpg'],
  ]},
  { label: 'Black seed', href: 'black-seed-oil.html', menu: [
    ...
    ['index.html#kits', 'Black Seed Softgels', '60 × 1000 mg', 'assets/img/products/black-seed-softgels/front.jpg'],
  ]},
  { label: 'Bundles & kits', href: 'index.html#kits' },
...
export const products = [
  ...
  {
    slug: 'qahwa-collagen', file: 'qahwa-collagen.html', navKey: 'Collagen',
    name: 'Qahwa + Collagen',
...
export const catalogue = {
  ...
  'black-seed-honey':    { href: '#', name: 'Black Seed Honey', flag: 'The bridge jar', img: 'assets/img/products/black-seed-honey/front.jpg', desc: 'Sidr-grade honey infused with cold-pressed nigella.', pr: '€29', note: '· wave 2' },
  'tasting-flight':      { href: '#', name: 'The Tasting Flight', flag: 'The gifting door', img: 'assets/img/products/tasting-flight/front.jpg', desc: 'Three 40 g honeys with the report booklet.', pr: '€35', note: '· gift-boxed' },
  'morning-ritual':      { href: '#', name: 'The Morning Ritual', flag: 'The starter kit', img: 'assets/img/products/morning-ritual/front.jpg', desc: 'Fourteen mornings of sticks, sachets and softgels.', pr: '€59', note: '· 14 days' },
};
