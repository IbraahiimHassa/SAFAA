...
export const products = [
  ...
  },
  {
    ...
    title: "Black Seed Softgels — 1000 mg, TQ-graded, fish-gelatin shell · SAFA Nutrition",
    meta: 'Sixty 1000 mg softgels of the same cold-pressed, TQ-graded Nigella sativa oil as the bottle, in a fish-gelatin shell — never bovine.',
    flag: 'Companion to the oil',
    cat: '60 softgels · 1000 mg · fish-gelatin shell',
    ...
    bullets: [
      ...
      ['leaf', 'Fish-gelatin shell — never bovine, never porcine'],
